...
def get_conversational_history(user_question_history,chatbot_answer_history,conversational_memory_length,additional_context):
    """
...
def main():
    ...
    flag_key = 'is_first_time'

    # Check if the flag exists in the session state, indicating not the first use
    if flag_key not in st.session_state:
        st.session_state[flag_key] = True  # Set flag to True initially
    ...
    if user_question:
        ...
        conversational_history_question = get_conversational_history(st.session_state['user_question_history'],st.session_state['chatbot_answer_history'],conversational_memory_length,additional_context)
